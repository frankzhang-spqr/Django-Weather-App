...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'weather_app.context_processors.weather_settings',
            ],
        },
    },
]
...
# Use SQLite for development if no PostgreSQL settings are found
if not all([os.getenv('PGDATABASE'), os.getenv('PGUSER'), os.getenv('PGPASSWORD'),
